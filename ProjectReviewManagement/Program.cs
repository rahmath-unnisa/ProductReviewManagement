...
namespace ProductReviewManagement
{
    class program
    {
        static void Main(string[] args)
        {
            ...
            reviewList.Add(new ProductReview() { ProductId = 1, UserId = 1, Rating = 5, Review = "Nice", IsLike = true });
            ...
            reviewList.Add(new ProductReview() { ProductId = 6, UserId = 9, Rating = 5, Review = "Nice", IsLike = true });
            reviewList.Add(new ProductReview() { ProductId = 7, UserId = 23, Rating = 4, Review = "NotBad", IsLike = true });
            reviewList.Add(new ProductReview() { ProductId = 8, UserId = 10, Rating = 5, Review = "Nice", IsLike = true });
            ...
            reviewList.Add(new ProductReview() { ProductId = 11, UserId = 7, Rating = 5, Review = "Nice", IsLike = true });
            ...
            reviewList.Add(new ProductReview() { ProductId = 14, UserId = 14, Rating = 5, Review = "Nice", IsLike = true });
            ...
            reviewList.Add(new ProductReview() { ProductId =17, UserId = 22, Rating = 5, Review = "Nice", IsLike = true });
            ...
            reviewList.Add(new ProductReview() { ProductId = 20, UserId = 23, Rating = 5, Review = "Nice", IsLike = true });
            reviewList.Add(new ProductReview() { ProductId = 21, UserId = 16, Rating = 5, Review = "Nice", IsLike = true });
